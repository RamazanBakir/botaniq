...
export async function generateMetadata({ params }: ListingDetailPageProps): Promise<Metadata> {
  ...
  if (!listing) {
    return { title: 'Listing Not Found | Botaniq' };
  }
            ...
            <div className="lg:sticky lg:top-24 space-y-6">
              ...
              <div className="bg-[var(--color-warning-50)] border border-[var(--color-warning-200)] rounded-2xl p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-[var(--color-warning-800)]">Safety Tips</p>
                    <p className="text-sm text-[var(--color-warning-700)] mt-2 leading-relaxed">
                      Always inspect the boat in person before making a purchase. Verify all documentation and consider a marine survey.
                    </p>
                  </div>
                </div>
              </div>
